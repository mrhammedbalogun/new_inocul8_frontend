...
export const megaMenu: MegaColumn[] = [
  ...
  },
  {
    ...
    href: "/what-we-do/sexual-reproductive-health",
    links: [
      { label: "Hepatitis B Immunization", href: "/hepatitis-b" },
      { label: "HPV Immunization", href: "/what-we-do/sexual-reproductive-health/hpv-immunization" },
      { label: "HPV (Pay Small Small)", href: "/what-we-do/sexual-reproductive-health/hpv-pay-small-small" },
      { label: "Hepatitis A (HAV)", href: "/what-we-do/sexual-reproductive-health/hepatitis-a" },
      { label: "Gonorrhea", href: "/what-we-do/sexual-reproductive-health/gonorrhea" },
      { label: "HIV PEP", href: "/what-we-do/sexual-reproductive-health/hiv-pep" },
      { label: "HIV PrEP", href: "/what-we-do/sexual-reproductive-health/hiv-prep" },
    ],
  },
  {
    ...
    links: [
      { label: "USA / Canada Travel Bundle", href: "/what-we-do/travel-health/usa-canada-travel-bundle" },
      { label: "Australia Travel Bundle", href: "/what-we-do/travel-health/australia-travel-bundle" },
      { label: "Africa / Asia / Europe Bundle", href: "/what-we-do/travel-health/africa-asia-europe-travel-bundle" },
      ...
      { label: "Meningitis Travel Bundle", href: "/what-we-do/travel-health/meningitis-travel-bundle" },
    ],
  },
  {
    ...
    links: [
      { label: "myHealth Hepatitis B", href: "/what-we-do/myhealth/hepatitis-b" },
      { label: "myHealth Genital Warts", href: "/genital-warts" },
      { label: "myHealth Genital Herpes", href: "/what-we-do/myhealth/genital-herpes" },
    ],
  },
  {
    heading: "Other Immunization",
    href: "/what-we-do/other-immunization",
    links: [
      { label: "Flu Vaccine", href: "/what-we-do/other-immunization/flu-vaccine" },
      { label: "Shingles (Shingrix)", href: "/what-we-do/other-immunization/shingles-shingrix" },
      { label: "Meningococcal B (Bexsero)", href: "/what-we-do/other-immunization/meningococcal-b-bexsero" },
      { label: "Hep B Immunoglobulin (HBIG)", href: "/what-we-do/other-immunization/hepatitis-b-immunoglobulin" },
      { label: "Rabies Vaccine", href: "/what-we-do/other-immunization/rabies-vaccine" },
      { label: "Tetanus & Polio (Adults)", href: "/what-we-do/other-immunization/tetanus-polio-adults" },
      { label: "Tetanus & Polio (Children)", href: "/what-we-do/other-immunization/tetanus-polio-children" },
      { label: "Pneumococcal (PCV)", href: "/what-we-do/other-immunization/pneumococcal-conjugate-pcv" },
      { label: "Typhoid Packages", href: "/what-we-do/other-immunization/typhoid-packages" },
      { label: "Cholera Packages", href: "/what-we-do/other-immunization/cholera-packages" },
    ],
  },
  {
...
export const footerServices: NavLink[] = [
  ...
  { label: "Sexual & Reproductive Health", href: "/what-we-do/sexual-reproductive-health" },
  { label: "Travel Health Services", href: "/what-we-do/travel-health" },
  { label: "myHealth Services", href: "/what-we-do/myhealth" },
  { label: "Employee Wellness Initiative", href: "/what-we-do/employee-wellness-initiative" },
  { label: "Training & Workshops", href: "/what-we-do/training-workshops" },
];
