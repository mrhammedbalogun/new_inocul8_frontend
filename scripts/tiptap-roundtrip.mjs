...
//
// This script writes ONLY docs/tiptap-roundtrip-generated.md (freely regenerable machine
// output). It must NEVER write docs/tiptap-roundtrip-report.md — that file holds hand-curated
// judgement (the approved-differences analysis, the sanitizer-allowlist notes, the exhaustive
// emitted-markup sample) that this script has no way to reconstruct. The two used to be the
// same file, and every run silently destroyed the curated half; keep them separate.
//
...
const lines = [
  ...
  "",
  "> Generated by `scripts/tiptap-roundtrip.mjs` — do not hand-edit, it is overwritten on every " +
    "run. For the curated analysis (why the changes below are approved) and the sanitizer " +
    "allowlist notes, see [`docs/tiptap-roundtrip-report.md`](./tiptap-roundtrip-report.md).",
  "",
...
writeFileSync(new URL("../docs/tiptap-roundtrip-generated.md", import.meta.url), lines.join("\n"));
console.log(
