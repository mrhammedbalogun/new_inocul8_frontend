# Tiptap round-trip — generated report

> Generated by `scripts/tiptap-roundtrip.mjs` — do not hand-edit, it is overwritten on every run. For the curated analysis (why the changes below are approved) and the sanitizer allowlist notes, see [`docs/tiptap-roundtrip-report.md`](./tiptap-roundtrip-report.md).
